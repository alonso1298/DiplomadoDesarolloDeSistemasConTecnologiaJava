...
public class RegistroUsuarioMapper {
    ...
    public Usuario toUsuario(UsuarioRequestDTO usuarioRequestDTO){
        return new Usuario(null, usuarioRequestDTO.getNombre(), usuarioRequestDTO.getPrimerApellido(),
    ...
    public Domicilio toDomicilio(DomicilioDTO domicilioDTO){
        return new Domicilio(domicilioDTO.getCalle(), domicilioDTO.getNumExterior(),
